...
export const MOCK_MENU_ITEMS: Record<string, MenuItem[]> = {
  r1: [
    { id: 'i101', restaurantId: 'r1', categoryId: 'c101', name: 'Margherita Clássica', description: 'Molho de tomate San Marzano, mussarela de búfala, manjericão fresco', price: 39.90, emoji: '🍕', isAvailable: true, isHighlighted: true, tags: ['vegetariano'], prepTimeMinutes: 20, calories: 820 },
    { id: 'i102', restaurantId: 'r1', categoryId: 'c101', name: 'Quatro Queijos', description: 'Mussarela, provolone defumado, gorgonzola e parmesão reggiano', price: 45.90, emoji: '🍕', isAvailable: true, isHighlighted: false, tags: ['vegetariano'], prepTimeMinutes: 20, calories: 980 },
    { id: 'i103', restaurantId: 'r1', categoryId: 'c101', name: 'Frango com Catupiry', description: 'Frango desfiado temperado, Catupiry original, azeitona preta', price: 42.90, emoji: '🍕', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 22, calories: 900 },
    { id: 'i104', restaurantId: 'r1', categoryId: 'c101', name: 'Pepperoni Premium', description: 'Pepperoni importado em fartas fatias, mussarela extra', price: 48.90, emoji: '🍕', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 20, calories: 1050 },
    { id: 'i105', restaurantId: 'r1', categoryId: 'c102', name: 'Refrigerante 2L', description: 'Coca-Cola, Guaraná Antarctica ou Sprite', price: 12.00, emoji: '🥤', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 2, calories: 420 },
    { id: 'i106', restaurantId: 'r1', categoryId: 'c102', name: 'Suco Natural 500ml', description: 'Laranja, limão-cravo ou maracujá', price: 10.00, emoji: '🍋', isAvailable: true, isHighlighted: false, tags: ['natural'], prepTimeMinutes: 5, calories: 180 },
    { id: 'i107', restaurantId: 'r1', categoryId: 'c103', name: 'Brownie + Sorvete', description: 'Brownie artesanal quente com sorvete de baunilha Madagáscar', price: 18.00, emoji: '🍫', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 8, calories: 620 },
  ],
  r2: [
    { id: 'i201', restaurantId: 'r2', categoryId: 'c201', name: 'Smash Clássico', description: 'Blend 180g, queijo cheddar americano, picles crocante, molho especial da casa', price: 32.90, emoji: '🍔', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 15, calories: 720 },
    { id: 'i202', restaurantId: 'r2', categoryId: 'c201', name: 'Double Smash', description: 'Dois blends 180g, duplo cheddar, bacon defumado, cebola crispy', price: 42.90, emoji: '🍔', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 18, calories: 980 },
    { id: 'i203', restaurantId: 'r2', categoryId: 'c201', name: 'Mushroom Swiss', description: 'Blend 180g, cogumelos Paris e Portobello salteados, queijo suíço', price: 38.90, emoji: '🍔', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 18, calories: 810 },
    { id: 'i204', restaurantId: 'r2', categoryId: 'c201', name: 'Veggie Smash', description: 'Blend de grão de bico e cogumelos, cheddar vegano, rúcula, tomate', price: 35.90, emoji: '🌿', isAvailable: true, isHighlighted: false, tags: ['vegetariano'], prepTimeMinutes: 15, calories: 580 },
    { id: 'i205', restaurantId: 'r2', categoryId: 'c202', name: 'Batata Frita 200g', description: 'Crocante por fora, macia por dentro, temperada com alecrim', price: 15.90, emoji: '🍟', isAvailable: true, isHighlighted: false, tags: ['vegetariano'], prepTimeMinutes: 10, calories: 440 },
    { id: 'i206', restaurantId: 'r2', categoryId: 'c202', name: 'Onion Rings', description: 'Anéis de cebola empanados, molho barbecue defumado', price: 16.90, emoji: '🧅', isAvailable: true, isHighlighted: false, tags: ['vegetariano'], prepTimeMinutes: 12, calories: 390 },
  ],
  r3: [
    { id: 'i301', restaurantId: 'r3', categoryId: 'c301', name: 'Combo Sakura 20 peças', description: 'Hots, califórnia, skin e niguiri de salmão', price: 69.90, emoji: '🍱', isAvailable: true, isHighlighted: true, tags: ['sem glúten'], prepTimeMinutes: 30, calories: 820 },
    { id: 'i302', restaurantId: 'r3', categoryId: 'c301', name: 'Combo Especial 30 peças', description: 'Variedade completa com temaki bônus', price: 98.90, emoji: '🍱', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 35, calories: 1200 },
    { id: 'i303', restaurantId: 'r3', categoryId: 'c302', name: 'Temaki Salmão', description: 'Salmão fresco, cream cheese Philadelphia, pepino japonês', price: 22.90, emoji: '🌯', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 15, calories: 350 },
    { id: 'i304', restaurantId: 'r3', categoryId: 'c302', name: 'Temaki Atum', description: 'Atum fresco, cream cheese, cebolinha, gergelim negro', price: 24.90, emoji: '🌯', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 15, calories: 320 },
  ],
  r4: [
    { id: 'i401', restaurantId: 'r4', categoryId: 'c401', name: 'Bowl Proteico', description: 'Frango grelhado, quinoa, grão de bico, cenoura, espinafre, molho tahine', price: 28.90, emoji: '🥗', isAvailable: true, isHighlighted: true, tags: ['sem glúten', 'proteico'], prepTimeMinutes: 15, calories: 480 },
    { id: 'i402', restaurantId: 'r4', categoryId: 'c401', name: 'Bowl Mediterrâneo', description: 'Atum, azeitona kalamata, tomate cereja, pepino, queijo feta, folhas', price: 31.90, emoji: '🥗', isAvailable: true, isHighlighted: false, tags: ['sem glúten'], prepTimeMinutes: 12, calories: 410 },
    { id: 'i403', restaurantId: 'r4', categoryId: 'c402', name: 'Suco Verde', description: 'Couve manteiga, maçã verde, gengibre, limão, pepino', price: 14.90, emoji: '🥤', isAvailable: true, isHighlighted: false, tags: ['vegano', 'natural'], prepTimeMinutes: 5, calories: 90 },
    { id: 'i404', restaurantId: 'r4', categoryId: 'c402', name: 'Vitamina Power', description: 'Whey protein, banana, cacau, aveia, leite de amêndoas', price: 16.90, emoji: '🥤', isAvailable: true, isHighlighted: true, tags: ['proteico'], prepTimeMinutes: 5, calories: 340 },
  ],
  r5: [
    { id: 'i501', restaurantId: 'r5', categoryId: 'c501', name: 'Esfiha de Carne', description: 'Carne moída temperada com especiarias árabes, hortelã', price: 5.90, emoji: '🥙', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 5, calories: 180 },
    { id: 'i502', restaurantId: 'r5', categoryId: 'c501', name: 'Esfiha de Frango', description: 'Frango cremoso com requeijão, salsinha', price: 5.90, emoji: '🥙', isAvailable: true, isHighlighted: false, tags: [], prepTimeMinutes: 5, calories: 160 },
    { id: 'i503', restaurantId: 'r5', categoryId: 'c501', name: 'Kit 10 Esfihas', description: 'Escolha 10 unidades à vontade', price: 49.90, emoji: '📦', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 10, calories: 1800 },
    { id: 'i504', restaurantId: 'r5', categoryId: 'c502', name: 'Kafta Grelhada', description: 'Kafta bovina no carvão, arroz árabe, salada fatouche, molho de alho', price: 34.90, emoji: '🫕', isAvailable: true, isHighlighted: true, tags: [], prepTimeMinutes: 20, calories: 650 },
  ],
}
...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    items: [
      { id: 'oi1', menuItemId: 'i101', menuItemName: 'Margherita Clássica', emoji: '🍕', quantity: 2, unitPrice: 39.90, totalPrice: 79.80 },
      { id: 'oi2', menuItemId: 'i105', menuItemName: 'Refrigerante 2L', emoji: '🥤', quantity: 1, unitPrice: 12.00, totalPrice: 12.00 },
    ],
  ...
  },
  {
    ...
    restaurantId: 'r1', restaurantName: 'Pizzaria Roma',
    items: [
      { id: 'oi3', menuItemId: 'i102', menuItemName: 'Quatro Queijos', emoji: '🍕', quantity: 1, unitPrice: 45.90, totalPrice: 45.90 },
      { id: 'oi4', menuItemId: 'i106', menuItemName: 'Suco Natural', emoji: '🍋', quantity: 1, unitPrice: 10.00, totalPrice: 10.00 },
    ],
  ...
  },
  {
    ...
    driverId: 'u3', driverName: 'Diego Lima',
    items: [
      { id: 'oi5', menuItemId: 'i103', menuItemName: 'Frango com Catupiry', emoji: '🍕', quantity: 1, unitPrice: 42.90, totalPrice: 42.90 },
      { id: 'oi6', menuItemId: 'i107', menuItemName: 'Brownie + Sorvete', emoji: '🍫', quantity: 1, unitPrice: 18.00, totalPrice: 18.00 },
    ],
